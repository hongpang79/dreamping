...
<head>
  ...
  <meta property="og:image" content="/dreamping/00_images/SIMG_8811.jpg"/>
  <meta name="description" content="꿈에 그리던 아웃도어 레저 공간 캠핑(camping), 서핑(surfing), 글램핑(glamping) 수상레저(watersports), 낚시(fishing), 클라이밍(climbing), 서바이벌게임 등 모든 레저컨텐츠를 감성이 넘치는 한공간에서 체험하고 즐길수 있는 꿈의레저놀이 입니다.">
...
<section class="mbr-section mbr-section-hero mbr-section-full header2 mbr-parallax-background mbr-after-navbar" id="header2-t" style="background-image: url(/dreamping/00_images/IMG_8592.jpg);">
                ...
                <div class="mbr-section row">
                    <div class="mbr-table-md-up">
                        ...
                        <div class="mbr-table-cell col-md-5 content-size text-xs-center text-md-left">
                            ...
                            <h3 class="mbr-section-title display-2">Dream House</h3>

                            <div class="mbr-section-text">
                                <p>빌딩숲을 벗어나 흐르는 강물을 따라 길을 걷다 만나는...<br>따뜻항 향기가 나를 위로 하는 대자연속의 감성카페</p>
                            </div>
...
<section class="mbr-section mbr-section__container article" id="header3-13" style="background-color: rgb(255, 255, 255); padding-top: 20px; padding-bottom: 20px;">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <h3 class="mbr-section-title brush display-2">대자연속의 감성카페 드림하우스 </h3>
                <small class="mbr-section-subtitle">강남기준 30분, 잠실에서 20분 북한강변으로 펼쳐지는 대자연속 감성카페</small>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="container">
              <div class="card cart-block">
                  ...
                  <div class="card-block">
                    <h4 class="card-title">DREAM HOUSE</h4>
                    <p class="card-text">커피와 음료, 각종 문화시설과<br>휴양을 즐길 수 있는 공간 입니다.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="mbr-cards-col col-xs-12 col-lg-4" style="padding-top: 80px; padding-bottom: 80px;">
            <div class="container">
                <div class="card cart-block">
                    ...
                    <div class="card-block">
                        <h4 class="card-title">아웃도어바</h4>
                        <p class="card-text">복합 휴식공간<br>북한강을 바라보며 힐링을 할 수 잇는 휴식처 입니다.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="mbr-cards-col col-xs-12 col-lg-4" style="padding-top: 80px; padding-bottom: 80px;">
            <div class="container">
                <div class="card cart-block">
                    ...
                    <div class="card-block">
                        <h4 class="card-title">공용시설</h4>
                        <p class="card-text">개수대, 샤워실, 화장실 등이 있는 공용건물 입니다.</p>
                        <!--
